...
function onMouseMove(e) {
    if(rejim_nomer ==7 || rejim_nomer==8 || rejim_nomer==9 || rejim_nomer==0) {
...
function update() {
    if(rejim_nomer == 1) {
       ...
       /* if (isPressed[87]) { // W
        ...
        let m2=isPressed[87] ? 1 :(isPressed[83]? -1:0);
        player.position.x+=0.1 * m2 * Math.cos(horizontal_angle);
        player.position.y += 0.1 * m2 * Math.sin(horizontal_angle)
       // isPressed[87] ? player.position.x += 0.1 * Math.cos(horizontal_angle):player.position.x -= 0.1 * Math.cos(horizontal_angle);
        //isPressed[87] ? player.position.y += 0.1 * Math.sin(horizontal_angle):player.position.y -= 0.1 * Math.sin(horizontal_angle);
    ...
    if(rejim_nomer==2){
        let mnojitel = isPressed[65] ? 1 : (isPressed[68] ? -1 : 0)
        horizontal_angle = horizontal_angle + mnojitel * 0.05;
        let m=isPressed[87] ? 1 :(isPressed[83]? -1:0);
        player.position.x += 0.1 * m * Math.cos(horizontal_angle);
        player.position.y += 0.1 * m * Math.sin(horizontal_angle);
    ...
    if(rejim_nomer==3){
        ...
        player.position.x += 0.1 * m * Math.cos(horizontal_angle);
        player.position.y += 0.1 * m * Math.sin(horizontal_angle);
        camera.position.set(player.position.x-Math.cos(horizontal_angle)*2,player.position.y-Math.sin(horizontal_angle)*2,3);
        camera.up.set(0,0,1);
        camera.lookAt(player.position.x,player.position.y,player.position.z);
        player.rotation.z=horizontal_angle;
    }
    if(rejim_nomer==4){
        ...
        camera.up.set(0,0,1);
        next_x = player.position.x + 0.1*Math.cos(horizontal_angle);
        next_y = player.position.y + 0.1*Math.sin(horizontal_angle);
        next_z = player.position.z;
        camera.up.set(0, 0, 1);
    ...
    if(rejim_nomer==5){
        ...
        horizontal_angle = horizontal_angle + mnojitel * 0.05;
        let m=isPressed[87] ? -1 :(isPressed[83]? 1:0);
        vertical_angle = vertical_angle + m*0.05;
        let m2=isPressed[38] ? 1:(isPressed[40] ? -1:0);
        player.position.x += 0.1 * m2 * Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        player.position.y += 0.1 * m2 * Math.sin(horizontal_angle)*Math.sin(vertical_angle);
        camera.position.set(player.position.x,player.position.y,player.position.z);
        camera.up.set(0,0,1);
    ...
    if(rejim_nomer==6){
        ...
        player.position.x += 0.1 * m2 * Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        player.position.y += 0.1 * m2 * Math.sin(horizontal_angle)*Math.sin(vertical_angle);
        player.position.z += 0.1 * m2 * Math.cos(vertical_angle);
        camera.position.set(player.position.x,player.position.y,player.position.z);
        camera.up.set(0,0,1);
        next_x = player.position.x + 0.1*Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        next_y = player.position.y + 0.1*Math.sin(horizontal_angle)*Math.sin(vertical_angle);
    ...
    if(rejim_nomer == 7) {
        ...
        // Napravete tezi dva ifa v 2 reda kod :) (ternary operator)
        let m=isPressed[87] ? 1 :(isPressed[83]? -1:0);
        player.position.x += 0.1 * m * Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        player.position.y += 0.1 * m * Math.sin(horizontal_angle)*Math.sin(vertical_angle);
        player.position.z += 0.1 * m * Math.cos(vertical_angle);
        camera.position.set(player.position.x,player.position.y,player.position.z);
        camera.up.set(0,0,1);
        next_x = player.position.x + 0.1*Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        next_y = player.position.y + 0.1*Math.sin(horizontal_angle)*Math.sin(vertical_angle);
    ...
    if(rejim_nomer==8){
        ...
        player.position.y += 0.1 * m * Math.sin(horizontal_angle);
        //player.position.z += 0.1 * m * Math.cos(vertical_angle);
        camera.position.set(player.position.x-Math.cos(horizontal_angle)*2,player.position.y-Math.sin(horizontal_angle)*2,3-Math.sin(vertical_angle)*2);
        camera.up.set(0,0,1);
        //next_x = player.position.x + 0.1*Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        //next_y = player.position.y + 0.1*Math.sin(horizontal_angle)*Math.sin(vertical_angle);
        //next_z = player.position.z + 0.1*Math.cos(vertical_angle);
    ...
    if(rejim_nomer==9){
        ...
        player.position.y += 0.1 * m * Math.sin(horizontal_angle)*Math.sin(vertical_angle);
       // player.position.z += 0.1 * m * Math.cos(vertical_angle);
        let m2=isPressed[65] ? 1 : (isPressed[68] ? -1 : 0);
        player.position.x+=0.1 * m2 * Math.cos(horizontal_angle+Math.PI/2)*Math.sin(vertical_angle);
        player.position.y += 0.1 * m2 * Math.sin(horizontal_angle+Math.PI/2)*Math.sin(vertical_angle);
        camera.position.set(player.position.x,player.position.y,player.position.z);
        camera.up.set(0,0,1);
        next_x = player.position.x + 0.1*Math.cos(horizontal_angle)*Math.sin(vertical_angle);
        next_y = player.position.y + 0.1*Math.sin(horizontal_angle)*Math.sin(vertical_angle);
